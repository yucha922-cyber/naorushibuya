...
| **ビフォーアフター 6枚の画像** | `assets/img/beforeafter/caseN-before.jpg / -after.jpg` | [`assets/img/beforeafter/README.md`](assets/img/beforeafter/README.md) |
| **施術フローセクション 背景画像** | `assets/img/flow/bg.jpg` | [`assets/img/flow/README.md`](assets/img/flow/README.md) |
